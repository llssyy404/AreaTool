...
//-----------------------------------------------------------------------------
VOID TransformAxisAlignedBox( AxisAlignedBox* pOut, const AxisAlignedBox* pIn, FXMVECTOR Scale, FXMVECTOR Rotation,
                              FXMVECTOR Translation )
{
	...
	Corner = XMVector3Rotate(Corner * Scale, Rotation) + Translation;
...
BOOL IntersectRayAxisAlignedBox( FXMVECTOR Origin, FXMVECTOR Direction, const AxisAlignedBox* pVolume, FLOAT* pDist )
{
    ...
    XMVECTOR Center = XMLoadFloat3( &pVolume->Center );
	XMVECTOR Extents = XMLoadFloat3(&pVolume->Extents);
	XMVECTOR Scale = XMLoadFloat3(&pVolume->Scale);
    ...
    XMVECTOR t1 = ( AxisDotOrigin - Extents*Scale) * InverseAxisDotDirection;
    XMVECTOR t2 = ( AxisDotOrigin + Extents*Scale) * InverseAxisDotDirection;
    ...
    XMVECTOR ParallelOverlap = XMVectorInBounds( AxisDotOrigin, Extents*Scale);
